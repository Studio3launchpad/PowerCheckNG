      ...
      <GlassCard className="p-5 sm:p-6">
        <DashboardSection
          ...
          action={
            <Link
              to="/outages"
              className="inline-flex w-full items-center justify-center rounded-xl border border-primary/30 bg-primary/5 px-5 py-3 font-medium text-primary transition hover:bg-primary/10 sm:w-auto"
            >
              Open Outage Tracker →
            </Link>
          }
